...
## Work Experience
**Data Manager @ The Amplitude Study sponsored by Vertex Pharmaceuticals (_March 2024 - Present_)**
- Analyzed large-scale healthcare datasets to assess operational performance, including patient eligibility for clinical trials, clinician productivity, and resource allocation.
- Supported the team in extracting, cleaning, and analyzing data from general hospitals databases, laboratory databases and community outreaches programs to identify eligible participants for screening.
- Conducted data quality assurance (QA) on EDC data, identifying discrepancies, and implementing corrective actions to improve data integrity.
...
**Supervised by Assoiciate Prof. Daniel Uyeh**
...
## Certifications
- Bioinformatics for Biologists: Analysing and Interpreting Genomics Datasets at Wellcome Connecting Science
- Bioinformatics for Biologists: Introduction to Unix, Bash Scripting and R (97%) at Wellcome Connecting Science          
- Biomedical Researchers by CITI (Collaborative Institutional Training Initiative)  
- Biomedical Research with Children - Advanced by CITI
- Data and Safety Monitoring in Human Subjects Research by CITI                         
- GCP – Social and Behavioral Research Best Practices for Clinical Research by CITI
- Applied Data Science at WorldQuant University, USA


## Publications
1. Adelani A., Omolayo C., Adebayo O.T, and Okunlola, Y. Predicting Psychological Disorder in Parents of Children with Nephrotic Syndrome: A Comparative Study of Six (6) Machine Learning Classifiers(2024), Vol. 12, Issue 10, pp. 01-08, https://www.ijres.org/v12-i10.html
